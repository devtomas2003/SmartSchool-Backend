...
routes.get('/ativar/:hash', RegisterController.activateAccount);
routes.get('/getPass/:hash', PasswordRecover.getPass);
routes.post('/getTurmas', turmaController.show);
routes.use(authNormalUser);
routes.post('/offline', offlineController.getOffline);
routes.post('/checkSum', offlineController.getHash);
